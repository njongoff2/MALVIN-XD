...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "malvin~Zm1TjRYQ#MAdZSZqHNP2sejiFBg7ABSBevriLAd1AVSpPN_Z0Cj4",
// add your Session Id make sure it starts with malvin~
PREFIX: process.env.PREFIX || ".",
// add your prifix for bot   
BOT_NAME: process.env.BOT_NAME || "Sung jinwoo",
...
// automatic delete links witho remove member 
          ...
          OWNER_NUMBER: process.env.OWNER_NUMBER || "27656696518XXXX",
// add your bot owner number

OWNER_NAME: process.env.OWNER_NAME || "LIZERMAN FF YT",
// add bot owner name
...
// make false if want private mod
        ...
        AUTO_TYPING: process.env.AUTO_TYPIREAD_ME"false",
